...
if(is_post_request() && request_is_same_domain()) {
  ...
  if(isset($_POST['cpassword'])) { $user['cpassword'] = $_POST['cpassword']; }
...
<div id="main-content">
  ...
  <?php 
    echo "Passwords should be at least 12 characters and include at least one uppercase letter, lowercase letter, number, and symbol.<br><br>"; 
