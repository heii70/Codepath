...
<img src='http://i.imgur.com/xM0vh0C.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
Connecting links and keeping track of the ids were cumbersome. I was stuck on returning to the previous page from a new.php page; I solved the issue by passing the id to URL and using GET method to grab the id. Most of the tasks were simple but tedious.
